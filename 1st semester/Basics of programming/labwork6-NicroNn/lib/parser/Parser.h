#ifndef LABWORK6_LIB_PARSER_PARSER_H_
#define LABWORK6_LIB_PARSER_PARSER_H_
#include <iostream>
#include <map>
#include <string>
#include <sstream>
...
class ArgParser {
  public:
    ...
    ArgParser& StoreValues(std::vector<std::string>& external_var);
  ...
  private:
    struct Argument {
        ...
        std::vector<std::string>* external_multi_storage = nullptr;
    };
...
#endif //LABWORK6_LIB_PARSER_PARSER_H_
